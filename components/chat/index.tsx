...
export function Chat({
  ...
  return (
    <>
      <div className="flex flex-col md:group-has-[[data-variant=inset]]/sidebar-wrapper:h-[calc(100dvh_-_theme(spacing.2))] md:group-has-[[data-state=collapsed]]/sidebar-wrapper:group-has-[[data-variant=inset]]/sidebar-wrapper:h-dvh min-w-0 md:rounded-tl-xl bg-background md:group-has-[[data-variant=inset]]/sidebar-wrapper:border md:group-has-[[data-variant=inset]]/sidebar-wrapper:border-border md:group-has-[[data-state=collapsed]]/sidebar-wrapper:group-has-[[data-variant=inset]]/sidebar-wrapper:border-none">
        <ChatHeader
          chatId={id}
